 ...
 *
 * @param pkt   Packet handle
 * @param opt   Proto stats options. If NULL is set, then proto stats update is
 *              disabled for this packet.
 *
 * @see odp_proto_stats_capability_t::tx::oct_count0_adj
 * @see odp_proto_stats_capability_t::tx::oct_count1_adj
 */
